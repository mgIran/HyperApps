...
<div class="panel panel-success">
    ...
    <div class="panel-body step-content information-step">
        <div class="container-fluid">
            <div class="alert alert-info" role="alert" style="margin: 50px 0;"><h4 class="text-center" style="margin: 0">به جمع توسعه دهندگان هایپر اپس خوش آمدید.</h4></div>
            <p style="margin-bottom: 30px;">از این پس می توانید برنامه های خود را در هایپر اپس ارائه کنید. جهت ورود به پنل روی دکمه زیر کلیک کنید.</p>
