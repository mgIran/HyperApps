...
class AppCategories extends CActiveRecord
{
    ...
    public function sortList()
    {
        ...
        foreach ( $parents as $parent ) {
            $childes = $this->findAll($this->getCategoryChilds($parent->id ,false));
    ...
    public function adminSortList()
    {
        ...
        foreach ( $parents as $parent ) {
            ...
            $childes = $this->getCategoryChilds($parent->id);
	...
	public function getCategoryChilds($id = null ,$withSelf = true){
		if($id)
			$this->id = $id;
		$criteria = new CDbCriteria();
